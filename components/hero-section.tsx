    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-primary/5 via-secondary/10 to-background py-20 sm:py-32">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col items-center text-center">
          <div className="mb-8 flex items-center gap-4 sm:gap-6 animate-float">
            <Image
          ...
          <h1 className="text-5xl font-bold tracking-tight text-balance sm:text-7xl mb-6 animate-slide-up bg-gradient-to-br from-foreground to-foreground/70 bg-clip-text text-transparent">
            {t.hero.title}
          </h1>
